      ...
      >
        <Combobox.Target>
          <div 
            ...
            className='flex cursor-pointer hover:bg-mine-shaft-900 items-center text-sm xs-mx:text-xs border border-bright-sun-400 rounded-xl xsm-mx:mt-2 px-2 py-1 xs-mx:px-1 xs-xm:py-0  pr-1'>
