  ...
  return (
    ...
    className='!fixed'
        ...
        <div className='flex flex-col gap-5'>
            ...
            <div className='flex gap-10 [&>*]:w-1/2'>
                <NumberInput readOnly={preview} variant={preview ? "unstyled" : "default"} className={`${preview?"text-mine-shaft-300 font-semibold" : ""}`} label='Phone Number' withAsterisk placeholder='Enter Phone Number' hideControls min={0} max={999999999} clampBehavior='strict'/>
